...
posts_nested_router.register(r'likes', LikeViewSet)
...
users_nested_router = routers.NestedSimpleRouter(router, r'users', trailing_slash=False, lookup='to_user')
users_nested_router.register(r'follows', FollowViewSet)
users_nested_router.register(r'likes', LikeViewSet)
