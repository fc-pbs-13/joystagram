# Generated by Django 3.0.7 on 2020-08-06 08:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='elastic.Manufacturer', verbose_name='manufacturer')),
            ],
            options={
                'verbose_name': 'Car',
